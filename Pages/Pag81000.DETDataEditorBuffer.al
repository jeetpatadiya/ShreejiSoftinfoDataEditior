page 81000 "DET Data Editor Buffer"
{
    ...
    Permissions = tabledata "Vendor Ledger Entry" = RMID, tabledata "FA Ledger Entry" = RMID, tabledata "Job Ledger Entry" = RMID, tabledata "Item Ledger Entry" = RMID,
     ...
     tabledata "Workflow Step Instance Archive" = RMID, tabledata "G/L Entry" = RMID, tabledata "Value Entry" = RMID, tabledata "G/L Register" = RMID, tabledata "Bank Acc. Reconciliation" = RMID,
     tabledata "Item Register" = RMID, tabledata "Reversal Entry" = RMID, tabledata "G/L Entry - VAT Entry Link" = RMID, tabledata "VAT Entry" = RMID, tabledata "Bank Acc. Reconciliation Line" = RMID,
     tabledata "Bank Account Statement" = RMID, tabledata "Bank Account Statement Line" = RMID, tabledata "Tracking Specification" = RMID, tabledata "Reservation Entry" = RMID,
     ...
     tabledata "Registered Invt. Movement Line" = RIMD, tabledata "Registered Whse. Activity Hdr." = RIMD, tabledata "Approval Entry" = RIMD, tabledata "Change Log Entry" = RIMD, tabledata "Service Connection" = RIMD, tabledata "Integration Synch. Job Errors" = RIMD,
     tabledata "Workflow Webhook Entry" = RIMD, tabledata "Workflow Webhook Notification" = RIMD;
    ...
    local procedure TestFieldIsPartOfPK(var RecRef: RecordRef; var FieldRefVar: FieldRef)
    var
        FieldRefVar2: FieldRef;
